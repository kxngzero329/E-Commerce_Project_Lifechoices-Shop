...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
  if (!isset($_SESSION['user_id']) || $_SESSION['username'] !== 'luke123') {
  ...
  header("Location: luke_products.php");
  exit();
}
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="luke_cart.php">Cart</a></li>
  ...
  <div class="alert alert-success text-center" role="alert">
    You are logged in as <strong>Luke</strong>
  </div>
  <div class="container mt-5">
    <h1 class="text-center mb-5 display-4">Available Products</h1>
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="post" action="luke_products.php">
